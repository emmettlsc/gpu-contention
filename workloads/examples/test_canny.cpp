/*
 * standalone test harness for canny edge detection
 *
 * builds: g++ test_canny.cpp ../canny.cu -o test_canny -I../../past-work/include `pkg-config --cflags --libs opencv4` -lcudart
 * or use cmake target: make test_canny_example
 *
